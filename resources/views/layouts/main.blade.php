	...
	<div class="header-top-grid hidden-lg hidden-md float-none">
		...
		@guest
			<ul class="profile-menu">                        
				...
				<li><a href="{{url('/find-a-chef')}}" class="active">BOOK A CHEF</a></li>
		...
		@else
			<ul class="profile-menu">                        
				...
				<li>
					<a class="register-link-grid" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form2').submit();">
						{{ __('Logout') }}
					</a>
	...
	<div class="site-wrapper clearfix">
		...
		<div class="header-mobile clearfix" id="header-mobile">
			<div class="header-mobile__logo">
				<h1><a href="{{url('/')}}"><img alt="logo" src="{{asset('img/logo.png')}}" /></a></h1>
			</div>
							...
							<div class="header-right-grid hidden-sm hidden-xs">                                    
								...
								@else
									<ul class="profile-menu">                        
										<li><a href="{{ url(Auth::user()->user_type) }}" class="">{{ Auth::user()->first_name }}</a></li>
										<li>
											<a class="register-link-grid" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form1').submit();">
												{{ __('Logout') }}
											</a>
...
<footer class="footer-main">
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <img class="img-fluid footer-logo" alt="logo" src="{{asset('img/footer-logo-img.png')}}" />                
			...
			<div class="col-md-7">
				<ul class="footer-menu">                    
                    ...
                    <li><a href="https://blog.bestlocalchef.com/">Blog </a></li>					
                </ul>
			</div>
			<div class="col-md-2">
			  <ul class="social-icon footer-social-icon">
		...
		<div class="row">
            <div class="col-md-12">
				<p class="copyright">Copyright © 2020 Best Local Chef. All Rights Reserved. Website Designed by <a href="https://www.atxwebdesigns.com/">ATX Web Designs</a>
</p>
			</div>
		</div>
    </div>
                ...
                <div class="login px-md-4 text-center">
                    ...
                    <form method="POST" action="{{ route('login') }}" id="loginForm">
						...
						<div class="row forgot-grid">
							...
							<div class="col-md-6 col-6 text-right hari">
...
<!-- <script type="text/javascript" src="{{asset('public/js/compiled.js')}}"></script> -->
