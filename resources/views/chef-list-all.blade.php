  ...
  <div class="container">
    ...
    <div class="row pt-3">
      ...
      <div class="col-md-3">
        <div class="chef_card">
          <div class="like_img">
            <img src="{{asset('uploads/profiles')}}/{{$chef->profile_pic}}" class="img-fluid">
            @auth
          ...
          <div class="card_text">
            ...
            <h3><a href="{{route('chef.profile.view',$chef->id)}}">{{$chef->first_name}} {{$chef->last_name}}</a></h3>
            <p>From ${{$chef->avg_cost}}<span>/meal</span></p>
          </div>
        </div>
      </div>
      @endforeach
