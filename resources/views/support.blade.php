		...
		<div class="booking_section row">
			<div class="col-md-7 col_left">
				<div class="contetn_left_div">
					<h3 class="h3_profile">Support</h3>
					<div class="banking_information_form mt-4">
						...
						<form method="post" action="{{ route('support.store') }}" onsubmit="return submitUserForm();">
							{{ csrf_field() }}
							<div class="row">
								...
								<div class="col-md-12">
									<textarea id="messageval" name="message" class="form-control" placeholder="Message" style="width: 100%; height: 150px;"></textarea>
