                        ...
                        <div class="form_section">
                            ...
                            <div class=" row">
                                ...
                                <div class="col-md-12 chef-account-data-row" id="certificate_data">
                                    ...
                                    <?php $m = unserialize($profile->certificate_data);
                                    //  print_r($m['names']);
                                    // die(); 
                                    $certificate_data_count = count($m['names']); ?>
                                    @foreach( $m['names'] as $namesKey => $namesValue)

                                    <input type="text" name="certificate_data[names][{{$namesKey}}]" value="{{$namesValue}}" placeholder="Certification name" class="form-control remove-certdata-{{$namesKey}}" />

                                    <input type="text" name="certificate_data[numbers][{{$namesKey}}]" value="{{$m['numbers'][$namesKey]}}" placeholder="Certification number" class="form-control remove-certdata-{{$namesKey}}" /> <br /><br /><br />
                            ...
                            <div class="meals_s_l">
                                ...
                                <?php
                                // echo "<pre>";
                                // print_r($profile->available_dates);
                                // echo "</pre>";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#add_more_certificate').click(function() {
            var innerHTML = `<div class="remove-certdata-${count }"> <a href="javascript:void(0);" class="remove-cert" data-id="${count }">(X)</a><input type="text" name="certificate_data[names][${count }]" value="" placeholder="Certification name" class="form-control remove-certdata-${count }" /><div class="remove-certdata-${count }"></div><input type="text" name="certificate_data[numbers][${count }]" value="" class="form-control remove-certdata-${count }"  placeholder="Certification number"/>`;
        ...
        $('#add_more_videos').click(function() {
            // console.log('dfdfd');
            var innerHTML = `<div class="remove-videodata-${count }" data-id="${count }" ><input type="text" class="remove-videodata-${count }" data-id="${count }" name="videos[]"  value="{{$profile->video_url}}" placeholder="Video Link">
        ...
        $(document).on('click', '#add_dates', function() {
            ...
            // }
            //var formData = new FormData('#dates-form');
            //var formData = new FormData(document.getElementById('dates-form'))
