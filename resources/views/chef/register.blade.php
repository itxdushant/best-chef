				...
				<div class="col-md-12 col-lg-8 offset-lg-2">
					<div class="row flex-row-reverse">
						<div class="col-md-8 col-8">
							<div class="vc-element-grid text-right mb-2 novisible">
								<span class="hidden-signupwith mr-2" style="font-size:14px;">or Sign up with</span>
								<!--Facebook-->
								<a href="{{ url('/auth/google') }}" class="btn btn-gplus mb-2"><i class="fa fa-google mr-md-2"></i> <span class="visible-lg-inline-block">Google +</span></a>
								<!--Google +-->
								<a href="{{ url('/auth/facebook') }}" class="btn btn-fb mb-2"><i class="fa fa-facebook mr-md-2"></i> <span class="visible-lg-inline-block">Facebook</span></a>
							</div>
						</div>
						<div class="col-md-4 col-4 pr-md-0">
							<div class="vc-element-grid text-left">
								<h3 class="title-heading-medium">Join Now</h3>
							</div>
							@if (session('status'))
					...
					<form class="register-form-grid" action="{{ route('register') }}" method="post" enctype="multipart/form-data">
						 @csrf               
					...
					<div class="row">
						<div class="form-group col-sm-6 pr-sm-1">
							...
							<input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
							@if ($errors->has('email'))
								<span class="invalid-feedback" role="alert">
				   ...
				   <div class="my-1">
					...
					<button type="submit" class="btn btn-default more-btn btn-block">Join</button>
				</form>
