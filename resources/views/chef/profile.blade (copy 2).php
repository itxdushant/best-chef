                    ...
                    <form  action="{{ url('chef/update-profile') }}" method="post" class="edit-profile-form-box chef-account">
                        ...
                        <div class="container">
                            <div class="row">                           
                                ...
                                <div class="col-md-12 chef-account-data-row">
                                    <label>Email</label>
                                    <input type="email" name="email" placeholder="myemail@gmail.com" value="{{$profile->email}}" />
                                    @if ($errors->has('email'))
                               ...
                               <!--  <div class="col-md-12 chef-account-data-row">
                                ...
                                <div class="col-md-12 chef-account-data-row">
                                    <div class="row">
                                        <div class="col-md-6 text-center">
                                            <label class="qualification-label">Service Area by Zip <a class="search-tooltip"> <i class="fas fa-info-circle"></i><span class="tooltiptext">How many miles outside of this zip code do you want to travel?</span></a></label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="qualification" name="miles_away" placeholder="" value="{{$profile->miles_away}}" required oninvalid="this.setCustomValidity('Please select a range')" oninput="setCustomValidity('')">
                    ...
                    <div class="border-box-frame">                  
                        ...
                        <div class="container">
                            ...
                            <div class="week">
								...
								<input type="checkbox" name="dates[sunday][close]" {{ ( isset($vdates["sunday"]["close"]) )  ? "checked"  : "" }}> Not Available
                                <!--<span class="closed-checkbox">									
